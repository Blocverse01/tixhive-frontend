    ...
    <div>
      <div className='flex items-center'>
        <button
          ...
          className='bg-brand-red mr-3 connect-wallet h-[45px] md:h-[56px] px-5 lg:px-0 lg:w-[170px] text-white text-[18px] leading-[35px] flex justify-center items-center darker-red rounded-lg'
        >
          {isAuthenticating ? (
